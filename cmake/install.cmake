...
function(vfc_install_library)
	...
	set_property(TARGET ${ARGS_TARGET} PROPERTY SOVERSION ${VFC_MAJOR_VERSION})
	...
	if (VFC_SHARED)
		...
		elseif (CMAKE_C_COMPILER_ID MATCHES "GNU" OR CMAKE_C_COMPILER_ID MATCHES "Clang")
			file(WRITE ${exportPath}
				"#pragma once\n\n"
				"#define VFC_EXPORT __attribute__((visibility(\"default\")))\n")
		else()
			file(WRITE ${exportPath}
				"#pragma once\n\n"
				"#define VFC_EXPORT\n")
	...
	set(configPackageDir lib/cmake/VFC)
